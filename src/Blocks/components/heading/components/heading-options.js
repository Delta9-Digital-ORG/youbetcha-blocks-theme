...
export const HeadingOptions = (attributes) => {
	...
	const headingLevels = [
		{ label: 'H1', tooltip: __('Heading 1', 'you-betcha-cannabis-theme'), value: 1 },
		{ label: 'H2', tooltip: __('Heading 2', 'you-betcha-cannabis-theme'), value: 2 },
		{ label: 'H3', tooltip: __('Heading 3', 'you-betcha-cannabis-theme'), value: 3 },
		{ label: 'H4', tooltip: __('Heading 4', 'you-betcha-cannabis-theme'), value: 4 },
		{ label: 'H5', tooltip: __('Heading 5', 'you-betcha-cannabis-theme'), value: 5 },
		{ label: 'H6', tooltip: __('Heading 6', 'you-betcha-cannabis-theme'), value: 6 },
	];
	...
	return (
		<UseToggle {...generateUseToggleConfig(attributes, manifest, 'headingUse')}>
			...
			>
				{!hideColor &&
					<ColorPicker
						label={(!hideSize && !hideFontWeight) ? null : <IconLabel icon={icons.color} label={__('Color', 'you-betcha-cannabis-theme')} />}
				...
				{!hideSize &&
					<Select
						...
						placeholder={__('Size', 'you-betcha-cannabis-theme')}
						noBottomSpacing
						simpleValue
						noSearch
					/>
				...
				{!hideFontWeight && fontSizes[fontSize]?.weightOptions?.length > 0 &&
					<Select
						...
						placeholder={__('Weight', 'you-betcha-cannabis-theme')}
						noBottomSpacing
						simpleValue
						noSearch
					/>
				...
				{!hideHeadingLevel &&
					<Menu
						...
						tooltip={__('Heading level', 'you-betcha-cannabis-theme')}
