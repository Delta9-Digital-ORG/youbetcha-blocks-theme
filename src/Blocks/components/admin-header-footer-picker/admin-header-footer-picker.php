...
<div class="wrap">
	...
	if (isset($_GET['settings-updated'])) { // phpcs:ignore
		add_settings_error(ReusableBlocksHeaderFooter::ADMIN_MESSAGE_SLUG, 'save_success', __('Settings saved', 'you-betcha-cannabis-theme'), 'updated');
	}
	...
	<div class="wrap">
		...
		<form action="options.php" method="post">
			...
			// Render save button.
			submit_button(__('Save', 'you-betcha-cannabis-theme'));
			?>
		</form>
	</div>
</div>
