		...
		<UseToggle {...generateUseToggleConfig(attributes, manifest, 'buttonUse')}>
			...
			{!hideVariantPicker &&
				<OptionSelector
					...
					label={__('Style', 'you-betcha-cannabis-theme')}
					value={buttonVariant}
			...
			{!hideColorPicker &&
				<ColorPicker
					...
					tooltip={__('Color', 'you-betcha-cannabis-theme')}
					inlineLabel
					expanded
					border
				/>
			...
			<Section showIf={!hideAriaLabel} icon={icons.a11y} label={__('Accessibility', 'you-betcha-cannabis-theme')} collapsable reducedBottomSpacing>
				<TextControl
					label={<IconLabel icon={icons.ariaLabel} label={__('ARIA label', 'you-betcha-cannabis-theme')} />}
					value={buttonAriaLabel}
					onChange={(value) => setAttributes({ [getAttrKey('buttonAriaLabel', attributes, manifest)]: value })}
					help={__('Description of the button.', 'you-betcha-cannabis-theme')}
				/>
			</Section>

			<Section showIf={!hideId} icon={icons.tools} label={__('Advanced', 'you-betcha-cannabis-theme')} collapsable noBottomSpacing>
				<TextControl
					label={<IconLabel icon={icons.id} label={__('Unique identifier', 'you-betcha-cannabis-theme')} />}
					value={buttonId}
