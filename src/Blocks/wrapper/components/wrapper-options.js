...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	const {
		label = __('Spacing & layout', 'you-betcha-cannabis-theme'),
		showWrapperId = true,
	...
	let wrapperUseOptions = [
		{
			label: __('Just the block', 'you-betcha-cannabis-theme'),
			value: 'off',
	...
	if (wrapperSimpleShowControl) {
		wrapperUseOptions = [...wrapperUseOptions, {
			label: __('Spacing only', 'you-betcha-cannabis-theme'),
			value: 'simple',
					...
					{!wrapperNoControls && wrapperUseShowControl &&
						<div className='es-display-flex es-items-center es-gap-1 es-ml-auto es-flex-shrink-0 es-mr-1 es-wrapper-options-copy-paste'>
							<Button
								...
								label={__('Copy configuration', 'you-betcha-cannabis-theme')}
								showTooltip
							/>
							...
							<Button
								...
								className='es-button-icon-24 es-button-square-24 es-rounded-0.75!'
								label={__('Paste configuration', 'you-betcha-cannabis-theme')}
								showTooltip
							/>
						</div>
					}
			...
			{wrapperUse &&
				<>
					...
					{wrapperUse && showWrapperTag &&
						<OptionSelector
							label={__('Wrapper tag', 'you-betcha-cannabis-theme')}
							icon={icons.code}
					...
					<Section
						icon={icons.ruler}
						label={__('Spacing', 'you-betcha-cannabis-theme')}
					...
					>
						{showWrapperSpacingTop &&
							<ResponsiveNumberPicker
								...
								label={__('Top', 'you-betcha-cannabis-theme')}
						...
						{showWrapperSpacingBottom &&
							<ResponsiveNumberPicker
								...
								label={__('Bottom', 'you-betcha-cannabis-theme')}
						...
						{(!noLeftSpacingInSelector || !noRightSpacingSelector) &&
							<Collapsable label={__('More', 'you-betcha-cannabis-theme')} icon={icons.moreH}>
								{!noLeftSpacingSelector &&
									<ResponsiveNumberPicker
										icon={icons.spacingLeft}
										label={__('Left', 'you-betcha-cannabis-theme')}
								...
								{!noRightSpacingSelector &&
									<ResponsiveNumberPicker
										...
										label={__('Right', 'you-betcha-cannabis-theme')}
						...
						{showWrapperSpacingTopIn &&
							<ResponsiveNumberPicker
								...
								label={__('Top inner', 'you-betcha-cannabis-theme')}
						...
						{showWrapperSpacingBottomIn &&
							<ResponsiveNumberPicker
								...
								label={__('Bottom inner', 'you-betcha-cannabis-theme')}
						...
						{(!noLeftSpacingInSelector || !noRightSpacingInSelector) &&
							<Collapsable label={__('More', 'you-betcha-cannabis-theme')} icon={icons.moreH} noBottomSpacing>
								{!noLeftSpacingInSelector &&
									<ResponsiveNumberPicker
										icon={icons.spacingLeftIn}
										label={__('Left inner', 'you-betcha-cannabis-theme')}
								...
								{!noRightSpacingInSelector &&
									<ResponsiveNumberPicker
										...
										label={__('Right inner', 'you-betcha-cannabis-theme')}
					...
					<Section
						...
						icon={icons.design}
						label={__('Design', 'you-betcha-cannabis-theme')}
					>
						{showWrapperBgColorPicker &&
							<AdvancedColorPicker
								icon={icons.backgroundType}
								label={__('Background', 'you-betcha-cannabis-theme')}
								colorsProject={backgroundColors}
								value={wrapperBgColorProject}

								pickerPopupTitle={__('Background', 'you-betcha-cannabis-theme')}
								groupShades
								canReset
								...
								types={
									[
										{
											label: __('None', 'you-betcha-cannabis-theme'),
											value: '',
											icon: icons.emptyCircle,
										},
										{
											label: __('Project color', 'you-betcha-cannabis-theme'),
											value: 'project',
											icon: icons.colorAlt,
										},
										{
											label: __('Gradient', 'you-betcha-cannabis-theme'),
											value: 'gradient',
											icon: icons.gradient,
										}
									]
						...
						{showWrapperRoundedCorners &&
							<ResponsiveNumberPicker
								...
								label={__('Rounded corners', 'you-betcha-cannabis-theme')}
						...
						{(showWrapperDividerTop || showWrapperDividerBottom || showWrapperDividerLeft || showWrapperDividerRight || showWrapperDividerColor) &&
							<Collapsable
								icon={icons.divider}
								label={__('Divider', 'you-betcha-cannabis-theme')}
								subtitle={
									showWrapperDividerColor &&
									(wrapperDividerTopLarge || wrapperDividerRightLarge || wrapperDividerBottomLarge || wrapperDividerLeftLarge) &&
									!wrapperDividerColor &&
									<span className='es-color-yellow-500 es-font-weight-500'>{__('Color not set!', 'you-betcha-cannabis-theme')}</span>
								}
								actions={
									(wrapperDividerTopLarge || wrapperDividerRightLarge || wrapperDividerBottomLarge || wrapperDividerLeftLarge) &&
									(
							...
							>
								{showWrapperDividerColor &&
									<ColorPicker
										colors={[{ name: __('None', 'you-betcha-cannabis-theme'), slug: undefined, color: 'transparent' }, ...dividerColors]}
										...
										pickerPopupTitle={__('Divider color', 'you-betcha-cannabis-theme')}
										label={__('Color', 'you-betcha-cannabis-theme')}
										icon={icons.colorAlt}
									/>
								}
											...
											{breakpointNames.map((breakpoint, index) => {
												...
												return (
													<Button
														...
														label={attributeValue ? __('On', 'you-betcha-cannabis-theme') : __('Off', 'you-betcha-cannabis-theme')}
														showTooltip
													/>
												);
											})}
					...
					<Section
						...
						icon={icons.tools}
						label={__('Advanced', 'you-betcha-cannabis-theme')}
						subtitle={__('Visibility, anchor, ID', 'you-betcha-cannabis-theme')}
						noBottomSpacing
						collapsable
					>
						{showWrapperHide &&
							<ResponsiveToggleButton
								...
								label={__('Hide', 'you-betcha-cannabis-theme')}
								icon={icons.hide}
							/>
						}
						...
						{showWrapperAnchorId &&
							<TextControl
								label={<IconLabel icon={icons.anchor} label={__('Block Anchor ID', 'you-betcha-cannabis-theme')} />}
						...
						{showWrapperId &&
							<TextControl
								label={<IconLabel icon={icons.id} label={__('Block unique identifier', 'you-betcha-cannabis-theme')} />}
								value={wrapperId}
