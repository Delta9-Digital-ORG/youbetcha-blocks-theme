 ...
 *
 * @package YouBetchaCannabisTheme\Manifest
 */

declare(strict_types=1);

namespace YouBetchaCannabisTheme\Manifest;

use YouBetchaCannabisTheme\Config\Config;
use YouBetchaCannabisThemeVendor\EightshiftLibs\Manifest\AbstractManifest;
